...
Write-Host 'Agent: ai-engineer (AI Engineer)' -ForegroundColor Cyan
Write-Host 'â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•' -ForegroundColor Cyan
Write-Host ''
...
Get-Content 'C:\Users\Takhi\Desktop\Project\SaaS-Product\workspace\agents\ai-engineer.md' -Encoding UTF8 | Write-Host -ForegroundColor Gray
Write-Host ''
