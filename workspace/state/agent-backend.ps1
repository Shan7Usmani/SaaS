...
Write-Host 'Agent: backend (Backend Engineer)' -ForegroundColor Cyan
Write-Host 'â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•' -ForegroundColor Cyan
Write-Host ''
...
Get-Content 'C:\Users\Takhi\Desktop\Project\SaaS-Product\workspace\agents\backend.md' -Encoding UTF8 | Write-Host -ForegroundColor Gray
Write-Host ''
